 ...
 * 基本文本编辑组件
 * 修改记录
 * 1. 修改了UI对象干涉BUG 05/28-2012 hucj
 * @author   Changjian Hu
 * @encoding UTF-8
 * @version  1.0
 * @create   May 4, 2012 2:33:56 PM
 */
public class OPasswordFieldUI extends BasicPasswordFieldUI   {
    // Shared UI object
    //private static OPasswordFieldUI cui;
    private OPasswordField comp;
    ...
    public static ComponentUI createUI(JComponent c) {
        return new OPasswordFieldUI(c);
    }
    
    public OPasswordFieldUI(JComponent com) {
        comp = (OPasswordField)com;
    	model = comp.getModel();
    }
