...
import com.original.client.border.InnerShadowBorder;
...
import com.original.client.ui.widget.FileAttacher;
import com.original.client.ui.widget.FontChooser;
...
//				return false;
	...
	//顶部功能按钮面板
	public class Top extends SGPanel implements ActionListener, EventConstants
	{
		public Top() {
		...
		public void addButtonItems(boolean leftToRight, AbstractButtonItem... buttonItems )
		{
			...
			if(buttonItems != null && buttonItems.length > 0)
			{
				for(AbstractButtonItem buttonItem : buttonItems) {
					SGButton button = ChannelUtil.createAbstractButton(buttonItem);
	...
	//中间编辑面板
	public class Center extends SGPanel implements ActionListener, FocusListener, EventConstants
	{
		...
		//一些功能按钮
		private SGPanel control = new SGPanel(new ChannelGridLayout(5, 0, new Insets(0, 5, 0, 0)));
		private SGButton btnFont =(SGButton) ChannelUtil.createAbstractButton(
				...
				btnImage = (SGButton) ChannelUtil.createAbstractButton(
				...
				btnFile = (SGButton) ChannelUtil.createAbstractButton(
				...
				btnDebug =  (SGButton) ChannelUtil.createAbstractButton(
		...
		//文本面板
		private SGTextPane content = new SGTextPane();
		
		//按钮对应的对话框
		private FontChooser fontChooser = new FontChooser(content);
		private SGFileChooser fileChooser = new SGFileChooser();
...
//			btnDebug.addActionListener(this);
			...
			layoutMgr.addComToModel(new SGLabel("内容："));
