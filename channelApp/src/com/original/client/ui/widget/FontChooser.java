...
import com.seaglasslookandfeel.widget.SGComboBox;
import com.seaglasslookandfeel.widget.SGPanel;
import com.seaglasslookandfeel.widget.SGTextPane;
import com.seaglasslookandfeel.widget.SGToggleButton;
 ...
 *
 */
public class FontChooser extends SGPanel implements ActionListener, ItemListener,  CaretListener, EventConstants
{
	private static GraphicsEnvironment ge = GraphicsEnvironment.getLocalGraphicsEnvironment();
	private static DefaultComboBoxModel familiesModel = null,
			sizesModel = null;
	private JComboBox families = new SGComboBox(),
			sizes = new SGComboBox();
	
	private SGToggleButton bold = ChannelUtil.createAbstractButton(
			new AbstractButtonItem(null, BOLD_STYLE, 
					IconFactory.loadIconByConfig("boldFontIcon"),
					IconFactory.loadIconByConfig("boldFontSelectedIcon"), null), SGToggleButton.class),
			...
			italic = ChannelUtil.createAbstractButton(
					new AbstractButtonItem(null, ITALIC_STYLE, 
							...
							IconFactory.loadIconByConfig("italicFontSelectedIcon"), null), SGToggleButton.class),
			...
			underline = ChannelUtil.createAbstractButton(
					new AbstractButtonItem(null, UNDERLINE_STYLE, 
							...
							IconFactory.loadIconByConfig("underLineSelectedIcon"), null), SGToggleButton.class);
	
	private SGColorChooser colorChooser = new SGColorChooser(Color.black);
			private SGButton color =  ChannelUtil.createAbstractButton(
	...
	private SGTextPane editor = null;
	...
	public FontChooser(SGTextPane editor) //overall是否是全局样式
	{
		this.editor = editor;
		fs.setEditor(editor);
