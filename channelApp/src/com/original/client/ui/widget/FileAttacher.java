 ...
 *
 */
public class FileAttacher extends SGPanel implements ActionListener, EventConstants
{
	...
	private SGButton btnDel = ChannelUtil.createAbstractButton(
	...
	private JComboBox attacherBox = new SGComboBox();
	private SGFileChooser attachChooser = new SGFileChooser();
