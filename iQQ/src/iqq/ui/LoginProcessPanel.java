    ...
    public void login() throws Exception {
        ...
        Runnable toLoginRunnable = new Runnable() {
            ...
            public void run() {
                ...
                loginAI = Auth.getAccountInfo((String)loginMap.get("account"));
                loginStatus(isLogin);
        ...
        Runnable loginRunnable = new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    member = memberService.getMemberInfo(loginAI, loginAI.getMember());
                    lblProcess.setText("正在下载用户头像...");
                    member.setFace(memberService.getFace(loginAI));
                    lblProcess.setText("正在加载好友列表...");
                    categoryList = categoryService.getFriends(loginAI);
                    lblProcess.setText("正在加载在线好友...");
                    onlineFriends = categoryService.getOnlineFriends(loginAI);
                } catch (Exception ex) {
                    Logger.getLogger(LoginProcessPanel.class.getName()).log(Level.SEVERE, null, ex);
                }
                //下载群列表到缓存，等待加载...
                lblProcess.setText("正在加载群组列表...");
                GroupService.getInstance().downloadGroupList(loginAI);
