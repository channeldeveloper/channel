...
public class MainPanel extends javax.swing.JPanel {
    ...
    public MainPanel() {
        ...
        mainFrame.setIconImage(loginAI.getMember().getFace().getImage());
        Log.println("mainPanel");
        this.setVisible(true);

        //设置托盘
        try {
            TrayFactory.getInstance().createTray(mainFrame, loginAI.getMember().getFace(), "Hello，" + loginAI.getMember().getNickname() + "!");
        } catch (Exception ex) {
    ...
    private void comboStatusItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_comboStatusItemStateChanged
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                MemberService.getInstance().changeStatus(loginAI, loginStatus);
            }
        };
                ...
                if (path != null) {
                    ...
                    if (obj instanceof IconTreeNode) {
                        ...
                        Runnable r = new Runnable() {
                            ...
                            public void run() {
                                try {
                                    member.setFace(MemberService.getInstance().downloadFace(loginAI,member));
                                    if (member.getLevel() == null || member.getLevel().equals("")) {
                                        try {
                                            //下载个人信息
                                            member = MemberService.getInstance().getMemberInfo(loginAI,member);
                                        } catch (Exception ex) {
                                            Logger.getLogger(MainPanel.class.getName()).log(Level.SEVERE, null, ex);
                                        }
                                    }
    ...
    public void initGroupTab() {
        List<Group> grouptList = GroupService.getInstance().downloadGroupList(loginAI);
    ...
    public void initRecentTab() {
        ...
        Runnable r = new Runnable() {
            ...
            public void run() {
                ...
                List<Member> recentList = CategoryService.getInstance().getRecentList(loginAI);
    ...
    public synchronized void changeStatus(Category category) throws Exception {
        ...
        DefaultMutableTreeNode emptyTreeNode = new DefaultMutableTreeNode(" ");
        List<Member> onlineFriends = CategoryService.getInstance().getOnlineFriends(loginAI);
